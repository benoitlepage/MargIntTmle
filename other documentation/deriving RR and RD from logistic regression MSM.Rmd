...
\begin{equation*}
\frac{\partial}{\partial \beta} (\log p) = \frac{\frac{\partial p}{\partial \beta}}{p} =\frac{-\frac{\partial e}{\partial \beta}}{(1+e)p^2} \times (1 + e)=\frac{\frac{\partial e}{\partial \beta}}{1+e} 
\end{equation*}
