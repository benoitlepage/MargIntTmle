...
perf_gcomp_bin %>%
  kable(format = "latex",
        ...
        escape = TRUE)
```
Note that the standard error was not estimated in 150 simulations out of 1000, resulting in a missing average standard error and coverage for the $\log\text{RERI}$ indicator.
